    ...
    const sampleProducts: InsertProduct[] = [
      {
        ...
        length: "22 inches",
        texture: "straight",
        images: ["/attached_assets/stock_images/woman_long_straight__87475d1c.jpg"],
        inStock: true,
        stockCount: 15,
        featured: true,
        badge: "Best Seller",
      },
      {
        ...
        length: "18 inches",
        texture: "straight",
        images: ["/attached_assets/stock_images/woman_long_straight__eee03e54.jpg"],
        inStock: true,
        stockCount: 20,
        featured: true,
        badge: "New",
      },
      {
        ...
        length: "20 inches",
        texture: "straight",
        images: ["/attached_assets/stock_images/beautiful_african_wo_7f5bcd22.jpg"],
        inStock: true,
        stockCount: 8,
        featured: true,
        badge: "Premium",
      },
      {
        ...
        length: "16 inches",
        texture: "body-wave",
        images: ["/attached_assets/stock_images/beautiful_african_wo_8e308ce0.jpg"],
        inStock: true,
        stockCount: 12,
        featured: true,
      },
      {
        ...
        length: "14 inches",
        texture: "straight",
        images: ["/attached_assets/stock_images/woman_long_straight__1bf9cbec.jpg"],
        inStock: true,
        stockCount: 25,
        featured: false,
      },
      {
        ...
        length: "22 inches",
        texture: "deep-wave",
        images: ["/attached_assets/stock_images/beautiful_african_wo_217fa6d2.jpg"],
        inStock: true,
        stockCount: 5,
        featured: false,
        badge: "Limited",
      },
      {
        ...
        price: 12000,
        category: "hair-care",
        images: ["/attached_assets/stock_images/hair_care_products_b_dceab05b.jpg"],
        inStock: true,
        stockCount: 50,
        featured: false,
      },
      {
        ...
        price: 8500,
        category: "hair-care",
        images: ["/attached_assets/stock_images/hair_care_products_b_5c926556.jpg"],
        inStock: true,
        stockCount: 40,
        featured: false,
      },
