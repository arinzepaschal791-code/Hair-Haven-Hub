...
class Product(db.Model):
    ...
    price = db.Column(db.Float, nullable=False)  # Changed from Numeric to Float
    category = db.Column(db.String(50))  # hair, wigs, care
    image_url = db.Column(db.String(500))
    video_url = db.Column(db.String(500))
    image_urls = db.Column(db.Text, default='[]')  # JSON string of multiple images
    stock = db.Column(db.Integer, default=0)
    featured = db.Column(db.Boolean, default=False)
    product_code = db.Column(db.String(50), unique=True)  # Changed from 'sku' to 'product_code'
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
